...
run_evasion_attacks:
	...
	python -m attack_generation.adversarials.run_attacks --data_name cifar10 --train_data_fp data/clean/cifar10/subset_id0_r0.1/train.pt --test_data_fp data/clean/cifar10/subset_id0_r0.1/test.pt --model_conf_fp configs/resnet/resnet_fmnist.json --dir_suffix subset_id0_r0.1 --seed 0 --device cpu