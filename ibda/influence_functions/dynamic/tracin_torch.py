...
from ibda.models.base import BaseModel

from ..base_influence import BaseInfluenceEstimator


class TracInInfluenceTorch(BaseInfluenceEstimator):
    def __init__(
        self,
        ...
        self.ckpts_file_paths = ckpts_file_paths
    ...
    def compute_train_to_test_influence(
        ...
        tracin_cp = self._init_tracin_cp(
            dataset=train_set,
            ckpts_file_paths=self.ckpts_file_paths,
            batch_size=self.batch_size,
            layers=self.layers,
            fast_cp=self.fast_cp,
        )
